...
/**
 * Cette classe est la classe reliée à la classe statisticsLayerClientRel qui sert à envoyer le nombre de messages
...
class ThreadEnvoiRel extends FrancThread
  {
   ...
   private StatisticsLayerClientRel clientLayer;
   ...
   private MessagePool mp;
		...
		*/ 
     public ThreadEnvoiRel (StatisticsLayerClientRel clientLayer,MessagePool mp, int frequence, int nbreMess)
     {
      super();
