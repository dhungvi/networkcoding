...
public final class StaticClassLoader {
  ...
  public static Object getInstanceFor(String name) {
    Object obj = null;
    /** Add a similar block as below for each class you need to instantiate statically.
    if(name.equals("a fully qualified class name")) {
	obj = new FullyQualifiedClassName();
    */
    return obj;
  }
}
